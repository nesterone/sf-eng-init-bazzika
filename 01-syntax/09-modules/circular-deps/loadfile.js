/* eslint no-unused-vars: [2, { "varsIgnorePattern": "exports" }] */
...
readFile.files = {
  weekDay: 'var names = [\'Sunday\', \'Monday\', \'Tuesday\', \'Wednesday\',\
...
backgroundReadFile.files = {
  ...
  today: 'define([], function() { return {dayNumber: \
    function() { return (new Date).getDay(); }}; });'
};
